...
class DonutChart {
    ...
    function findNeighborArc(i,data1,data0,key){
      var d;
      return (d=findPreceding(i,data1,data0,key))?{startAngle:d.endAngle,endAngle:d.endAngle}
        :(d=findFollowing(i,data1,data0,key))?{startAngle:d.startAngle,endAngle:d.startAngle}
        :null;
    }
